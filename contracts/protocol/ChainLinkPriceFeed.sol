...
//        requireNonEmptyAddress(address(aggregator));
    ...
    function getTwapPrice(bytes32 _priceFeedKey, uint256 _interval) external view override returns (uint256) {
        ...
        // if the latest updated timestamp is earlier than the target timestamp, return the latest price.
        ...
        while (true) {
            ...
            // check if the current round timestamp is earlier than the target timestamp
