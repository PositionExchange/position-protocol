...
library TickMath {
    ...
    /// at the given tick
    function getPriceAtTick(int256 tick) internal pure returns (uint256 sqrtPriceX96) {
    ...
    function getTickAtSqrtRatio(uint256 sqrtPriceX96) internal pure returns (int256 tick) {
