...
describe('Test Margin Intergration', function () {
    ...
    let _;
    let trader0, trader1, trader2, trader3, trader4;
    beforeEach( async function () {
        [trader0, trader1, trader2, trader3, trader4] = await ethers.getSigners();
        [
            positionHouse,
            positionManager,
    ...
    describe('margin without funding rate', function () {
        ...
        it('should count margin correctly when open reverse position with PnL > 0', function () {
