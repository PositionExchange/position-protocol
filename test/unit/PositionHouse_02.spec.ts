...
describe("PositionHouse_02", () => {
    ...
    describe('debug DTP', async function () {
        ...
        it("should close position while still have pending order", async function () {
            ...
            await positionHouse.connect(trader0).closePosition(positionManager.address, 18)
        ...
        it("should get correct list pending order", async function () {
            ...
            await positionHouse.connect(trader0).closeLimitPosition(positionManager.address, 510000, BigNumber.from('18000000000000000000'))
        ...
        it("should got correct open notional of market order", async () => {
            await openLimitPositionAndExpect({
                limitPrice: 5000,
                side: SIDE.SHORT,
                leverage: 10,
            ...
            await positionHouse.connect(trader4).closeLimitPosition(positionManager.address, 51000, 23)

            await positionHouse.connect(trader3).closePosition(positionManager.address,7)

            await positionHouse.connect(trader2).closeLimitPosition(positionManager.address,510000, 23)
        })
    })
})
